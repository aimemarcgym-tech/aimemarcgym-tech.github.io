      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <section className="md:col-span-2">
            <h2 className="mb-4 text-lg font-semibold accent-gradient-text">Mes gymnastes — classement par club</h2>
            {gymnasts.length === 0 ? (
          ...
          <section>
            <h2 className="mb-4 text-lg font-semibold accent-gradient-text">Ajouter une gymnaste</h2>
